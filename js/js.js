...
function programacao(numero){   
    ...
    if(numero == 2){
        ...
        document.getElementById('botao4').style.background="#dfe4ea";
        document.getElementById('botao5').style.background="#dfe4ea";
        document.getElementById('divProg').innerHTML = '<div id="divProg"> <div id="progInd"> <img src="imagens/rodadeconversa.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Roda de Conversa Papo com PyLadies </p> <p id="horario"> 13:00 - 14:30 </p> <p id="responsavel"> PyLadies Sul de Minas </p> <a id="link-meet" href="#"> ASSISTIR RODA DE CONVERSA </a> </div> </div> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Minicurso Arduíno </p> <p id="horario"> 15:00 - 18:00 </p> <p id="responsavel"> Instrutor: Albert - 6° Período </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/palestra.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Palestra Computação Forense </p> <p id="horario"> 19:00 - 21:00 </p> <p id="responsavel"> Palestrante: André Bononi </p> <a id="link-meet" href="#"> ASSISTIR PALESTRA </a> </div> </div> </div>';
    }
    ...
    if(numero == 3){
        ...
        document.getElementById('botao4').style.background="#dfe4ea";
        document.getElementById('botao5').style.background="#dfe4ea";
        document.getElementById('divProg').innerHTML = '<div id="divProg"> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Minicurso React </p> <p id="horario"> 13:00 - 17:00 </p> <p id="responsavel"> Instrutor: Jonatan - 4° Período </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Minicurso Git e GitHub </p> <p id="horario"> 16:00 - 18:00 </p> <p id="responsavel"> Instrutora: Marisa - 8° Período </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/palestra.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Palestra Lei Geral de Proteção de Dados (LGPD) - Desafios e oportunidades para o profissional de TI </p> <p id="horario"> 19:00 - 21:00 </p> <p id="responsavel"> Palestrante: Anderson Souza </p> <a id="link-meet" href="#"> ASSISTIR PALESTRA </a> </div> </div> </div>';
    }  
    ...
    if(numero == 4){
        ...
        document.getElementById('botao5').style.background="#dfe4ea";
        document.getElementById('divProg').innerHTML = '<div id="divProg"> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Minicurso React Native </p> <p id="horario"> 13:00 - 17:00 </p> <p id="responsavel"> Instrutor: Jonatan - 4° Período </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Minicurso Criando sites responsivos com o Bootstrap </p> <p id="horario"> 13:00 - 17:00 </p> <p id="responsavel"> Instrutora: Janaína - Docente </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/palestra.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Palestra Segurança Ofensiva </p> <p id="horario"> 19:00 - 22:30 </p> <p id="responsavel"> Palestrante: Joatham Pedro </p> <a id="link-meet" href="#"> ASSISTIR PALESTRA </a> </div> </div> </div>';
    } 
    ...
    if(numero == 5){
        ...
        document.getElementById('divProg').innerHTML = '<div id="divProg"> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Minicurso de Docker e Kubernetes </p> <p id="horario"> 13:00 - 17:00 </p> <p id="responsavel"> Instrutor: Luís Felipe - 8° Período </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Minicurso A importância do tratamento de imagens no comércio digital </p> <p id="horario"> 13:00 - 17:00 </p> <p id="responsavel"> Instrutora: Naiane </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/minicurso.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Aprendendo a programar com Python </p> <p id="horario"> 16:00 - 18:00 </p> <p id="responsavel"> Instrutora: Marisa - 8° Período </p> <a id="link-meet" href="#"> ASSISTIR MINICURSO </a> </div> </div> <div id="progInd"> <img src="imagens/palestra.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Palestra AWS Business Professional </p> <p id="horario"> 19:00 - 22:30 </p> <p id="responsavel"> Palestrante: Rafael Kelles </p> <a id="link-meet" href="#"> ASSISTIR PALESTRA </a> </div> </div> </div>';
    }   
}
